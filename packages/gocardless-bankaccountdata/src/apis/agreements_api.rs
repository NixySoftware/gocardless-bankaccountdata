...
pub async fn accept_eua(
    ...
    id: &str,
    enduser_acceptance_details_request: models::EnduserAcceptanceDetailsRequest,
...
pub async fn create_eua(
    configuration: &configuration::Configuration,
    end_user_agreement_request: models::EndUserAgreementRequest,
...
pub async fn retrieve_all_euas_for_an_end_user(
    configuration: &configuration::Configuration,
    limit: Option<i32>,
    offset: Option<i32>,
...
pub async fn retrieve_eua_by_id(
    configuration: &configuration::Configuration,
    id: &str,
