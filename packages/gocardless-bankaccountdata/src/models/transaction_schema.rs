...
pub struct TransactionSchema {
    ...
    pub transaction_amount: Box<models::TransactionAmountSchema>,
    ...
    pub creditor_account: Option<Box<models::AccountSchema>>,
    /// ultimateCreditor
    ...
    #[serde(
        rename = "balanceAfterTransaction",
        skip_serializing_if = "Option::is_none"
    )]
    pub balance_after_transaction: Option<Box<models::BalanceAfterTransactionSchema>>,
}
